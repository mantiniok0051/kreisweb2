...
export class GalleryComponent implements OnInit {
 ...
 //======= Gallery Albums CSS Style shortlist =======//
  ...
  /* ========= CSS styles shortlist UI ALBUMS MENU ==========*/
    ...
    public kitchens_btnVisible:string = ' col-xs-10 col-md-12 col-lg-12 gallery-btn-kitchen';
    public achitects_btnVisible:string = ' col-xs-10 col-md-12 col-lg-12 gallery-btn-architects';
    public arts_btnVisible:string = ' col-xs-10 col-md-12 col-lg-12 gallery-btn-art';
    public hiddenAlbum:string = ' col-lg-3 hidden-album';
    public hiddenItem:string = ' hidden-block';
    public visibleAlbum:string = ' col-md-3 col-lg-3  gallery-album-btn';
    public albumBlockHidden:string = ' col-md-3 col-lg-3';
